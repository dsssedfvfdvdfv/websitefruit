...
<div class="register-box">
  <div class="register-logo">
    <a href="/templates/index2.html"><b>Admin</b></a>
  </div>
    ...
    <div class="card-body register-card-body">
      ...
      <form action="/register/confirm" method="post">
        ...
        <div class="input-group mb-3">
          <input type="email" class="form-control" placeholder="Email" name="username" require>
        ...
        <div class="input-group mb-3">
          <input type="password" class="form-control" placeholder="Retype password" name="confirm" require>
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-lock"></span>
            </div>
