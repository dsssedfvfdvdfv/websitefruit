         ...
         "columns": [{
            ...
            },
            {
               ...
               "render": function(data, type, row) {
                  ...
                  var editLink = '<a href="/edit/' + row.id + '" class="btn btn-info edit-btn" ><i class="fa-solid fa-pen"></i></a>';
   ...
   $(document).on('click', '.delete-btn', function(e) {
      ...
      Swal.fire({
         ...
         if (result.isConfirmed) {
            ...
            setTimeout(() => {
               window.location.href = '/deactivate/' + userId;
            }, 1000);
